                    ...
                    <?php if(count($surveys_overview) > 0): ?>
                        <div style="grid-column: 1 / -1;">
                            ...
                            <div style="display:flex;gap:0.75rem;align-items:center;">
                                ...
                                <button onclick="var sel=document.getElementById('surveyDetailSelect');if(sel.value){window.location='reports.php?type=survey_detail&survey_id='+sel.value;}else{showConfirmModal('No Selection', 'Please select a survey.', {type: 'primary', confirmText: 'OK', icon: 'bi-exclamation-circle'}, function(){});}" class="btn btn-primary">
